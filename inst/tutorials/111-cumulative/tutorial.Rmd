...
<!--MP: Just preference but I like the socrates quote more
...
>>>>>>> 5846dc502636d512c97ba8dfb635ad8ca61e17fa
...
<!--MP: Justice is about concerns that you (or your critics) might have, reasons why the model you create might not work as well as you hope.  -->
...
<!--MP: I suggest utilizing this version since it is more word economic and efficient. Efficiency is key, since as a student I often struggled with absorbing large forms of content.  *The longer the time period covered by the Preceptor Table (and the data), the more suspect the assumption of stability becomes.*  -->
...
<!--MP: A change in time or the distribution of the data does not, in and of itself, demonstrate a violation of stability. Stability is about the parameters: the baseline approval rating, the effect of idealogy on approval ratings and so on. Stability means these parameters are the same in the data as they are in the population as they are in the Preceptor Table. -->
...
<!--MP: "add maybe" The reason that representativeness is important is because, when it is violated, the estimates for the model parameters might be biased.  -->
...
<!--MP: This assumption is only relevant for causal models. We describe a model as "confounded" if this is not true. The easiest way to ensure unconfoundedness is to assign treatment randomly. -->
...
<!-- Note that there is no test case for these and some other functions because they take too long to run. -->
...
<!-- In order to align with temperance, we must embrace humility. Would some hypothesis testing or a different model be within the realms of reason for students? Maybe a short introduction on p-value interpretation AND confidence intervals. (z/t-tests, z for proportions, t for means). Or maybe Bayesian Inference, -->


<!-- question_text(NULL, -->
<!-- 	message = "Bayesian inference provides a framework for updating beliefs about parameters based on the observed data. The prior distribution reflects our beliefs before seeing the data, and the likelihood represents the data's contribution. The posterior distribution is the updated belief after considering the data.", -->
<!-- 	answer(NULL, correct = TRUE), -->
<!-- 	allow_retry = FALSE, -->
<!-- 	incorrect = NULL, -->
<!-- 	rows = 6) -->
...
<!-- Exercise 2 requires us to load the libraries -->

<!-- Exercise 3 is us defining the models -->
<!-- Exercise 4 is us interpreting the posterior distribution -->
<!-- Exercise 5 is us plotting posterior distributions -->
<!-- Exercise 6 is credible intervals -->
<!-- Exercise 7 is interpreting our intervals with humility. -->
